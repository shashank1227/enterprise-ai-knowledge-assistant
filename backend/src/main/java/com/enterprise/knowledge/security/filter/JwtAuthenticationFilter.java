package com.enterprise.knowledge.security.filter;
...
/**
 * JWT authentication filter that intercepts every request, extracts the JWT token
 * from the Authorization header, validates it, and sets the authentication context.
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            // If email is present and no authentication is set yet
